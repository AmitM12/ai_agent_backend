...
ELEVENLABS_STABILITY = float(os.getenv("ELEVENLABS_STABILITY", "0.80"))
ELEVENLABS_SIMILARITY = float(os.getenv("ELEVENLABS_SIMILARITY", "0.70"))
ELEVENLABS_STYLE = float(os.getenv("ELEVENLABS_STYLE", "0.65"))
